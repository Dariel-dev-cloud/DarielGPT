...
function Credits() {
    ...
    return (
        <div className='max-w-7xl h-screen overflow-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12'>
            <h2 className="text-3xl font-semibold text-center mb-10 xl:mt-32
             text-gray-800 dark:text-white" >Planes de credito</h2>
                    ...
                    ${plan._id === 'pro' ? "bg-purple-50 dark:bg-purple-900" : "bg-white dark:bg-transparent"} `} >
                        <div className="flex-1 " >
                            ...
                            <p className="text-2xl font-bold text-purple-600
                             dark:text-purple-300 mb-4" >${plan.price}
                                <span className="text-base font-normal text-gray-600
                               dark:text-purple-200 " >{' '}/ {plan.credits} creditos</span>
                            </p>
                        ...
                        <button className="mt-6 bg-purple-600 hover:bg-purple-700
                         ...
                         transition-colors cursor-pointer">Comprar ahora</button>
                    </div>
                ))}
            </div>
