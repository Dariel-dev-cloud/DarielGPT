         ...
         overflow-scroll" >
            ...
            {images.length > 0 ? (
                ...
                dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow duration-300 " >
                            <img src={item.imageUrl} alt="" className="w-full h-40 md:h-52 2xl:h-64 object-cover
                ...
                backdrop-blur text-white px-4 py-1 rounded-t-xl opacity-0
                group-hover:opacity-100 transition duration-300" >Creado por {item.userName}</p>
                        </a>
                ...
                <p className="text-center text-gray-600 dark:text-purple-200 mt-10" >No hay imágenes
                    disponibles</p>
            )}
        </div>
    )
